...
public class MenuScene extends Scene {
    ...
    public MenuScene(KL keyListener,ML mouseListener){
        ...
        try{
            ...
            exitPressed = spritesheet.getSubimage(264,0,233,93); // wielkość napisów pobranych z pliku png
    ...
    public void update(double dt) {
        if(mouseListener.getX()>=playRect.x&&mouseListener.getX()<=playRect.x+playRect.width&&
            ...
            playCurrentImage = play;
        }//Gdy najedziemy myszką na przycisk play, naświetli się
        ...
        if(mouseListener.getX()>=exitRect.x&&mouseListener.getX()<=exitRect.x+exitRect.width&&
            ...
            if (mouseListener.isPressed()) {
                ...
                exitCurrentImage = exit;
            }//Gdy najedziemy myszką na przycisk exit, naświetli się

    }

    @Override
    public void draw(Graphics g) {
        g.setColor(new Color(255, 197, 64, 255));
        g.fillRect(0,0,Constans.SCREEN_WIDTH,Constans.SCREEN_HEIGHT);
        ...
        g.drawImage(exitCurrentImage,(int)exitRect.x,(int)exitRect.y,(int)exitRect.width,(int)exitRect.height,null); //Grafika napisów, upoziomowanie kolor tła itd.
    }
}
